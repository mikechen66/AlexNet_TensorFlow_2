...
def rotate(image):
    """
    Rotate the given image to 90 and 270 degrees to generate different images.
    :type image: Pillow Image object
    """
    # 90 degree
...
def mirror_and_rotate(image):
    """
    Mirror the image and then rotate(90 and 270 degrees separately.
    :type image: Pillow Image object
    """
...
def invert(image):
    """
    Invert the pixel intensities to produce different looking image.
    :type image: Pillow Image object
    """
...
def random_crop(image, times):
    """
    Randomly crop the given image for `times` many times.
    :type image: Pillow Image object

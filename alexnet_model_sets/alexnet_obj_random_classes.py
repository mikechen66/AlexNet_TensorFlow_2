...
class AlexNet(Sequential):
    ...
    def __init__(self, input_shape, num_classes):
        ...
        # Flatten the three dimensions of 256x6x6 into one dimension of 9216.
        self.add(Flatten())
...
# Generate the classe number of the random integer from 1 to 1000
NUM_CLASSES = random.randint(1, 1000)
